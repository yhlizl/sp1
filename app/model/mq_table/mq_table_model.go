...
// arModel is a active record design model for table mq_table operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of mq_table.
	Table = "mq_table"
	// Model is the model object of mq_table.
	Model = &arModel{g.DB("default").Model(Table).Safe()}
	// Columns defines and stores column names for table mq_table.
	Columns = struct {
		Item       string //   
        Status     string //   
        Starttime  string //   
